...
\begin{Definition}
  ...
  \defi{Elias-$\delta$-Encoding}{Elias-$\delta$-Encoding} is a way to represent a positive integer $x$ using $\lfloor\log (x)\rfloor+2\lfloor(\lfloor\log (x)\rfloor + 1)\rfloor+1$ bits.
