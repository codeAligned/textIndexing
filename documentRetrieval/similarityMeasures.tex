...
\begin{Definition}
  ...
  \begin{itemize}
    ...
    \item $F_{\mathcal{D},q}$ is the \defi{document frequency}{Document Frequency}. It counts the number of distinct documents from~$\mathcal{D}$ containing~$q$ at least once.
  \end{itemize}
\end{Definition}
